---
title: 'DeepLearning: Understanding The Basics'
date: 2020-09-21
...
Deep Learning is a subset of machine learning that performs better than the traditiona machine learning appraoches on big data. Deep Learning Algorithms or Artificial Intelligence (A.I.) are interconnected layers of Neurons. This interconnected network ingest a vast amount of Input data and process them through multiple layers that learn increasingly complex features of the data at each layer.

The most common type approach used for training Deep Learning models is known as Supervised Learning. Supervised Learning models are trained to perform classification or regression tasks. The models learn through representation. For example, given an image, each layer will attempt to learn a specific feature from that image to be able to differentiate between images.
